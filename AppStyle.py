...
def inject_modern_css():
    ...
    st.markdown(f"""
        ...
        ::-webkit-scrollbar-thumb {{
            background-color: #0A1931 !important; /* blue */
            border-radius: 6px !important;
            border: 2px solid #CBDCEB !important; 
        }}
        ::-webkit-scrollbar-thumb:hover {{
            background-color: #7cb7f7 !important; /* -blue */
...
/* 3. TRUE EDGE-TO-EDGE & FIXED HEIGHT BLOCK OVERRIDE */
        .main .block-container {{
            ...
            height: calc(100vh - 40px) !important; /* Locks main panel height */
        ...
        [data-testid="stDataFrame"] {{
            ...
            border: 2px solid #0A1931 !important;
            width: 100% !important;
            flex-grow: 1 !important; /* Forces table to stretch down to fill the screen */
            height: 60vh !important; /* Hard-coded fixed viewport box height */
        }}

        /* Forces underlying glide-data-grid cells to blend nicely */
        [data-testid="stDataFrame"] div {{
            background-color: transparent !important;
        }}
        ...
        /* Zebra stripes with transparency */
        [data-testid="stDataFrame"] tbody tr:nth-of-type(even) {{
            background-color: rgba(203, 220, 235, 0.4) !important;
        }}
        </style>
